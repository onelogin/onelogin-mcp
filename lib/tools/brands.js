...
export async function listBrands(api, args = {}) {
  ...
  // /api/2/branding/brands does not paginate: limit/page/after_cursor/before_cursor are
...
export const tools = [
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        limit: ignoredPaginationParam('number', 'brands'),
        page: ignoredPaginationParam('number', 'brands'),
        after_cursor: ignoredPaginationParam('string', 'brands'),
        before_cursor: ignoredPaginationParam('string', 'brands')
      },
