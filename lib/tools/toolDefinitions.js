 ...
 *
 * This file contains tool definitions extracted from index.js.
 * As tool files are migrated to the new format (exporting their own tools array),
...
/**
 * Legacy handler map - maps tool names to implementation functions
 */
export const legacyHandlerMap = {
  // User tools
  list_users: userTools.listUsers,
  get_user: userTools.getUser,
  create_user: userTools.createUser,
  update_user: userTools.updateUser,
  delete_user: userTools.deleteUser,
  unlock_user: userTools.unlockUser,
  get_user_apps: userTools.getUserApps,
  list_user_custom_attributes: userTools.listUserCustomAttributes,
  get_user_custom_attribute: userTools.getUserCustomAttribute,
  create_user_custom_attribute: userTools.createUserCustomAttribute,
  update_user_custom_attribute: userTools.updateUserCustomAttribute,
  delete_user_custom_attribute: userTools.deleteUserCustomAttribute,
  get_user_privileges: userTools.getUserPrivileges,
  get_user_delegated_privileges: userTools.getUserDelegatedPrivileges,

  // App tools
  list_apps: appTools.listApps,
  get_app: appTools.getApp,
  update_app: appTools.updateApp,
  create_app: appTools.createApp,
  delete_app: appTools.deleteApp,
  delete_app_parameter: appTools.deleteAppParameter,
  get_app_users: appTools.getAppUsers,

  // Role tools
  list_roles: roleTools.listRoles,
  get_role: roleTools.getRole,
  assign_role_to_user: roleTools.assignRoleToUser,
  remove_role_from_user: roleTools.removeRoleFromUser,
  create_role: roleTools.createRole,
  update_role: roleTools.updateRole,
  delete_role: roleTools.deleteRole,
  get_role_apps: roleTools.getRoleApps,
  set_role_apps: roleTools.setRoleApps,
  get_role_users: roleTools.getRoleUsers,
  get_role_admins: roleTools.getRoleAdmins,
  add_role_admins: roleTools.addRoleAdmins,
  remove_role_admin: roleTools.removeRoleAdmin,

  // Event tools
  list_events: eventTools.listEvents,
  get_event: eventTools.getEvent,

  // Group tools
  list_groups: groupTools.listGroups,
  get_group: groupTools.getGroup,

  // Privilege tools
  list_privileges: privilegeTools.listPrivileges,
  get_privilege: privilegeTools.getPrivilege,
  create_privilege: privilegeTools.createPrivilege,
  update_privilege: privilegeTools.updatePrivilege,
  delete_privilege: privilegeTools.deletePrivilege,
  get_privilege_roles: privilegeTools.getPrivilegeRoles,
  assign_role_to_privilege: privilegeTools.assignRoleToPrivilege,
  remove_role_from_privilege: privilegeTools.removeRoleFromPrivilege,
  get_privilege_users: privilegeTools.getPrivilegeUsers,
  assign_users_to_privilege: privilegeTools.assignUsersToPrivilege,
  remove_user_from_privilege: privilegeTools.removeUserFromPrivilege,

  // MFA tools
  get_available_factors: mfaTools.getAvailableFactors,
  enroll_factor: mfaTools.enrollFactor,
  verify_factor_enrollment_otp: mfaTools.verifyFactorEnrollmentOTP,
  verify_factor_enrollment_poll: mfaTools.verifyFactorEnrollmentPoll,
  activate_factor: mfaTools.activateFactor,
  get_factor_status: mfaTools.getFactorStatus,
  verify_factor: mfaTools.verifyFactor,
  verify_factor_poll: mfaTools.verifyFactorPoll,
  trigger_factor_verification: mfaTools.triggerFactorVerification,
  remove_factor: mfaTools.removeFactor,
  generate_mfa_token: mfaTools.generateMFAToken,

  // SAML tools
  generate_saml_assertion: samlTools.generateSAMLAssertion,
  verify_saml_assertion_factor: samlTools.verifySAMLAssertionFactor,

  // Invite Link tools
  generate_invite_link: inviteLinkTools.generateInviteLink,
  send_invite_link: inviteLinkTools.sendInviteLink
};


/**
 * Legacy tool definitions - extracted from index.js
 * These should be migrated to individual tool files over time
 */
export const legacyToolDefinitions = [
        {
          name: 'list_users',
